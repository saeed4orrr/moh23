...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " ميكا"
SudosS = {1127091205}
Sudos = {sudoid,1127091205}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '℘ :  𝑀𝐸𝐺𝐺𝐴 𝑆𝑂𝑈𝑅𝐶𝐸 .',url="t.me/KKKK5K"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = "'•𝑆𝐸𝐶𝑈𝑅𝐼𝑇𝑌 • '" ,data="Amr_"..data.sender_user_id.."_1"},{text ="' •𝐿𝐸𝐴𝐷𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..data.sender_user_id.."_2"}},
{{text ="' •𝐿𝐸𝐴𝐷𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..data.sender_user_id.."_3"},{text ="'•𝑈𝑆𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..data.sender_user_id.."_4"}},
{{text = '𝑂𝑅𝐼𝐺𝐼𝑁𝐴𝐿 𝐿𝐼𝑆𝑇',data="Amr_"..data.sender_user_id.."_5"},{text ="'•𝑂𝑊𝑁𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..data.sender_user_id.."_6"}},
}
}
if infomsg[2] == '1' then
...
reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = "'•𝑆𝐸𝐶𝑈𝑅𝐼𝑇𝑌 •'" ,data="Amr_"..data.sender_user_id.."_1"},{text ="' •𝐴𝐷𝑀𝐼𝑁 𝑅𝐼𝐺𝐻𝑇𝑆 • '",data="Amr_"..data.sender_user_id.."_2"}},
{{text ="' •𝐿𝐸𝐴𝐷𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..data.sender_user_id.."_3"},{text ="'𝑂𝑅𝐼𝐺𝐼𝑁𝐴𝐿 𝐿𝐼𝑆𝑇'",data="Amr_"..data.sender_user_id.."_4"}},
{{text = '℘ :  𝑀𝐸𝐺𝐺𝐴 𝑆𝑂𝑈𝑅𝐶𝐸 .',url="t.me/KKKK5K"}},
}
}
...
{{text = '℘ :  تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "ميكا"),data="delnamebot"}},
...
reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = "'•𝑆𝐸𝐶𝑈𝑅𝐼𝑇𝑌 •'" ,data="Amr_"..msg.sender.user_id.."_1"},{text ="' •𝐴𝐷𝑀𝐼𝑁 𝑅𝐼𝐺𝐻𝑇𝑆 •'",data="Amr_"..msg.sender.user_id.."_2"}},
{{text ="' •𝐿𝐸𝐴𝐷𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..msg.sender.user_id.."_3"},{text ="'•𝑈𝑆𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..msg.sender.user_id.."_4"}},
{{text ="'•𝑂𝑊𝑁𝐸𝑅 𝑅𝐼𝐺𝐻𝑇𝑆•'",data="Amr_"..msg.sender.user_id.."_6"},{text ="'•𝐺𝐴𝑀𝐸𝑆'",data="Amr_"..msg.sender.user_id.."_7"}},
{{text = '℘ :  𝑀𝐸𝐺𝐺𝐴 𝑆𝑂𝑈𝑅𝐶𝐸 .',url="t.me/KKKK5K"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '℘ :  لتفعيل بوت هنا .',url="t.me/KIDCRL"}},
}
}
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "ميكا"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "ميكا"),"اني لقميل "..(redis:get(bot_id..":namebot") or "ميكا"),(redis:get(bot_id..":namebot") or "ميكا").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "ميكا") then
...
{{text = '℘ :  𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/KKKK5K"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '℘ :  𝑀𝐸𝐺𝐺𝐴 𝑆𝑂𝑈𝑅𝐶𝐸 .',url="https://t.me/KKKK5K"}},
}
}
...
local Text = "*℘ :  WeLCoMe To 𝑀𝐸𝐺𝐺𝐴 𝑆𝑂𝑈𝑅𝐶𝐸  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '℘ :  𝑀𝐸𝐺𝐺𝐴 𝑆𝑂𝑈𝑅𝐶𝐸 .',url="https://t.me/Meggas"}},
{{text = '℘ :  inFo 𝑀𝐸𝐺𝐺𝐴 .',url="https://t.me/KKKK5K"}},
{{text = '℘ :  CoDeR .',url="https://t.me/Kidcrl"},{text = '℘ :  TwS .',url="https://t.me/KIDCRL"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/Meggas1/2&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
